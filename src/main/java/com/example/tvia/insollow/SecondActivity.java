package com.example.tvia.insollow;
        ...
        setContentView(R.layout.activity_second);
            ...
            public void led_1(View v){
                ...
                if(l1){
                    ...
                    a.run();
                    Toast.makeText(
                            SecondActivity.this, "LED 1 ON", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    Toast.makeText(SecondActivity.this, "LED 1 OFF", Toast.LENGTH_SHORT).show();
                }
            ...
            public void led_2(View v){
                ...
                if(l2){
                    ...
                    buf=("11").getBytes();
                    a.run();
                    Toast.makeText(SecondActivity.this, "LED 2 ON", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    buf=("12").getBytes();
                    a.run();
                    Toast.makeText(SecondActivity.this, "LED 2 OFF", Toast.LENGTH_SHORT).show();
                }
            ...
            public void led_3(View v){
                ...
                if(l3){
                    ...
                    buf=("13").getBytes();
                    a.run();
                    Toast.makeText(SecondActivity.this, "LED 3 ON", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    buf=("14").getBytes();
                    a.run();
                    Toast.makeText(SecondActivity.this, "LED 3 OFF", Toast.LENGTH_SHORT).show();
                }
